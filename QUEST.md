...
순수 HTML, CSS, JavaScript만으로 자기소개 웹페이지를 처음부터 만듭니다. DOM 조작, 이벤트 처리, 비동기 데이터 fetching을 직접 구현하면서 React 학습 전 필수 개념을 체득합니다.
...
1. GitHub 저장소 URL
2. 배포된 사이트 URL (GitHub Pages)
3. 데스크톱/모바일/다크모드 스크린샷
